...
class Role(BaseModel):
    ...
    name = StringField(max_length=32, unique=True, nullable=False,default='超级管理员', comment="角色名称")
    code = StringField(max_length=64, unique=True, nullable=False, default="default_code", comment="角色标识")
    ...
    create_time = DateTimeField(auto_now_add=True,default='2026.2.22 19:36', comment="创建时间")
    update_time = DateTimeField(auto_now=True,default='2026.2.22 19:36', comment="更新时间")
