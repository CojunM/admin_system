...
class IntegerField(Field):
    ...
    def __init__(self, primary_key: bool = False, auto_increment: bool = False, 
                 nullable: bool = False, default: Any = None, unique: bool = False, index: bool = False):
        super().__init__(primary_key, nullable, default, unique, index)
...
class UUIDField(Field):
    ...
    def __init__(self, primary_key: bool = False, nullable: bool = False, 
        ...
        # UUID 默认唯一
        super().__init__(primary_key, nullable, default, unique or primary_key, index)
...
class ForeignKeyField(Field):
    ...
    def __init__(self, to, backref: str = None, on_delete: str = "CASCADE", 
                 ...
                 unique: bool = False, index: bool = True):
        super().__init__(nullable=nullable, unique=unique, index=index)
        self.to_model = to
